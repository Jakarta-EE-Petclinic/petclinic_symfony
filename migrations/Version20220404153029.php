 ...
 */
final class Version20220404153029 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__pet AS SELECT id, owner_id, pet_type_id, name, date_of_birth FROM pet');
        ...
        $this->addSql('INSERT INTO pet (id, owner_id, pet_type_id, name, date_of_birth) SELECT id, owner_id, pet_type_id, name, date_of_birth FROM __temp__pet');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__visit AS SELECT id, pet_id, datum, information FROM visit');
        ...
        $this->addSql('INSERT INTO visit (id, pet_id, datum, information) SELECT id, pet_id, datum, information FROM __temp__visit');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__pet AS SELECT id, owner_id, pet_type_id, name, date_of_birth FROM pet');
        $this->addSql('DROP TABLE pet');
        $this->addSql('CREATE TABLE pet (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, owner_id INTEGER NOT NULL, pet_type_id INTEGER NOT NULL, name VARCHAR(255) NOT NULL, date_of_birth DATE NOT NULL)');
        $this->addSql('INSERT INTO pet (id, owner_id, pet_type_id, name, date_of_birth) SELECT id, owner_id, pet_type_id, name, date_of_birth FROM __temp__pet');
        $this->addSql('DROP TABLE __temp__pet');
        $this->addSql('CREATE INDEX IDX_E4529B857E3C61F9 ON pet (owner_id)');
        $this->addSql('CREATE INDEX IDX_E4529B85DB020C75 ON pet (pet_type_id)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__visit AS SELECT id, pet_id, datum, information FROM visit');
        $this->addSql('DROP TABLE visit');
        $this->addSql('CREATE TABLE visit (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, pet_id INTEGER NOT NULL, datum DATE NOT NULL, information VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO visit (id, pet_id, datum, information) SELECT id, pet_id, datum, information FROM __temp__visit');
        $this->addSql('DROP TABLE __temp__visit');
        $this->addSql('CREATE INDEX IDX_437EE939966F7FB6 ON visit (pet_id)');
    }
