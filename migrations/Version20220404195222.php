 ...
 */
final class Version20220404195222 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pettype (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, relation_id INTEGER NOT NULL, name VARCHAR(255) NOT NULL)');
        $this->addSql('CREATE INDEX IDX_88F55F863256915B ON pettype (relation_id)');
        $this->addSql('DROP TABLE pet_type');
        $this->addSql('DROP INDEX IDX_E4529B857E3C61F9');
        $this->addSql('DROP INDEX IDX_E4529B85DB020C75');
        $this->addSql('CREATE TEMPORARY TABLE __temp__pet AS SELECT id, owner_id, name, date_of_birth FROM pet');
        $this->addSql('DROP TABLE pet');
        $this->addSql('CREATE TABLE pet (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, owner_id INTEGER NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, date_of_birth DATE NOT NULL, CONSTRAINT FK_E4529B857E3C61F9 FOREIGN KEY (owner_id) REFERENCES owner (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO pet (id, owner_id, name, date_of_birth) SELECT id, owner_id, name, date_of_birth FROM __temp__pet');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pet_type (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY)');
        $this->addSql('DROP TABLE pettype');
        $this->addSql('DROP INDEX IDX_E4529B857E3C61F9');
        $this->addSql('CREATE TEMPORARY TABLE __temp__pet AS SELECT id, owner_id, name, date_of_birth FROM pet');
        $this->addSql('DROP TABLE pet');
        $this->addSql('CREATE TABLE pet (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, owner_id INTEGER NOT NULL, name VARCHAR(255) NOT NULL, date_of_birth DATE NOT NULL, pet_type_id INTEGER NOT NULL)');
        $this->addSql('INSERT INTO pet (id, owner_id, name, date_of_birth) SELECT id, owner_id, name, date_of_birth FROM __temp__pet');
        $this->addSql('DROP TABLE __temp__pet');
        $this->addSql('CREATE INDEX IDX_E4529B857E3C61F9 ON pet (owner_id)');
