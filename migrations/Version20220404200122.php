 ...
 */
final class Version20220404200122 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_88F55F863256915B');
        $this->addSql('CREATE TEMPORARY TABLE __temp__pettype AS SELECT id, name FROM pettype');
        $this->addSql('DROP TABLE pettype');
        $this->addSql('CREATE TABLE pettype (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO pettype (id, name) SELECT id, name FROM __temp__pettype');
        $this->addSql('DROP TABLE __temp__pettype');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__pet AS SELECT id, owner_id, name, date_of_birth FROM pet');
        $this->addSql('DROP TABLE pet');
        $this->addSql('CREATE TABLE pet (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, owner_id INTEGER NOT NULL, name VARCHAR(255) NOT NULL, date_of_birth DATE NOT NULL)');
        $this->addSql('INSERT INTO pet (id, owner_id, name, date_of_birth) SELECT id, owner_id, name, date_of_birth FROM __temp__pet');
        $this->addSql('DROP TABLE __temp__pet');
        $this->addSql('CREATE INDEX IDX_E4529B857E3C61F9 ON pet (owner_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__pettype AS SELECT id, name FROM pettype');
        $this->addSql('DROP TABLE pettype');
        $this->addSql('CREATE TABLE pettype (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, relation_id INTEGER NOT NULL)');
        $this->addSql('INSERT INTO pettype (id, name) SELECT id, name FROM __temp__pettype');
        $this->addSql('DROP TABLE __temp__pettype');
